...
public class Utils {
     ...
     * updated.
     */
    public static String getRepoFormattedDateString(String dateString){
     ...
     * commit.
     */
    public static String getCommitFormattedDateString(String dateString){
        ...
        if (duration.toDays() > 365) {
            long years = duration.toDays() / 365;
            return "committed " + years + (years > 1 ? " years ago" : " year ago");
        } else if (duration.toDays() > 30) {
            long months = duration.toDays() / 30;
            return "committed " + months + (months > 1 ? " months ago" : " month ago");
        } else if (duration.toDays() > 7) {
            long weeks = duration.toDays() / 7;
            return "committed " + weeks + (weeks > 1 ? " weeks ago" : " week ago");
        } else if (duration.toDays() > 0) {
            return "committed " + duration.toDays() + (duration.toDays() > 1 ? " days ago" : " day ago");
        } else if (duration.toHours() > 0) {
            return "committed " + duration.toHours() + (duration.toHours() > 1 ? " hours ago" : " hour ago");
        } else {
            return "committed " + duration.toMinutes() + (duration.toMinutes() > 1 ? " mins ago" : " min ago");
        }
    }
